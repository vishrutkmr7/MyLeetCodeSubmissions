    ...
    def makesquare(self, matchsticks: List[int]) -> bool:
        ...
        def findedges(l1, l2, l3, l4, i):
            ...
            if l1 > edge or l2 > edge or l3 > edge or l4 > edge:
                return False
            return (
                findedges(l1 + matchsticks[i], l2, l3, l4, i + 1)
                or findedges(l1, l2 + matchsticks[i], l3, l4, i + 1)
                or findedges(l1, l2, l3 + matchsticks[i], l4, i + 1)
                or findedges(l1, l2, l3, l4 + matchsticks[i], i + 1)
            )
